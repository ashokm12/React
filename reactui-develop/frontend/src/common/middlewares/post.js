import { getCookie, generateFormDataForJSON, gernerateJson } from '../config/utils';
...
export function postApi({
	...
	return new Promise((resolve, reject) => {
		...
		const params = isPayloadJson === 'multipart' ? generateFormDataForJSON(modifiedPayload) : gernerateJson(modifiedPayload);
